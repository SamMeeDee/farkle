...
public class main 
{
	...
	while (playAgain1 = true)
	{
		    ...
		    p1:while (p1Turn == true && (p1HasHotDice == true || p1ReRoll == true))
		    {
		        ...
		        if (p1Roll == 'y')
		        {
		            ...
		            if (game.checkHotDice(p1.getDice()) == true)
		            {
		                ...
		                p1.setScore(game.returnHotScore(), false);
		                p1HasHotDice = true;
		                game.resetHotScore();
		                p1.setDice();
		                continue p1;
		            ...
		            p1.setScore(game.scoreDice(p1.getDice()), false);
		            p1.setNumDice(game.reCountDice());
		            
		            System.out.println("Your score is: " + p1.getScore());
		            System.out.println("You have " + p1.getNumDice());
		            do
		            {
		            ...
		            if (p1Choice == 1){p1ReRoll = true; continue p1;}
		...
		p2:while (p2Turn == true && (p2HasHotDice == true || p2ReRoll == true))
		    {
		        System.out.println(p2.getName() + ", press y to roll your dice: ");
		        ...
		        if (p2Roll == 'y')
		        {
		            ...
		            {
		                System.out.println("You rolled hot dice! All your dice are scored,\nand you get to roll again!");
		                p2.setScore(game.returnHotScore(), false);
		                game.resetHotScore();
		                p2HasHotDice = true;
		                p2.setDice();
		                continue p2;
		            ...
		            p2.setScore(game.scoreDice(p2.getDice()), false);
		            p2.setNumDice(game.reCountDice());
		            
		            System.out.println("Your score is: " + p2.getScore());
		            System.out.println("You have " + p2.getNumDice());
		            do
		            {
		               System.out.println("\n1. Reroll your remaining dice (warning: if you farkle, you will lose ALL your score)"+
		                                  "\n2. End your turn"+"\nEnter your choice: ");
		            ...
		            if (p2Choice == 1){p2ReRoll = true; continue p2;}
	...
	if (playAgain == 1){playAgain1 = true; p1.setScore(0, true); p2.setScore(0, true); continue;}
